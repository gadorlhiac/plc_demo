...
#
#         Project: plc_demo.tsproj
#        PLC name: plc_example_1 (plc_example_1 Instance)
...
epicsEnvSet("LOCATION", "PLC:plc_example_1" )
...
epicsEnvSet("ADS_MAX_PARAMS",   "1105")
...
system("${ADS_IOC_TOP}/scripts/add_route.sh 172.21.148.148 ^172.*$")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:plc_example_1")
dbLoadRecords("save_restoreStatus.db", "P=PLC:plc_example_1:")
dbLoadRecords("caPutLog.db", "IOC=$(IOC)")

## TwinCAT task, application, and project information databases ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:plc_example_1,IDX=1")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=$(ASYN_PORT), PREFIX=PLC:plc_example_1")

dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:plc_example_1,PROJECT=plc_demo.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.15.2.dev0+g73bd2d9.d20230727,PLC_HOST=172.21.148.148")

#   lcls-twincat-motion: * -> 4.0.4 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:plc_example_1,DEPENDENCY=lcls-twincat-motion,VERSION=4.0.4,VENDOR=SLAC")
#   Tc2_Standard: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:plc_example_1,DEPENDENCY=Tc2_Standard,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_System: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:plc_example_1,DEPENDENCY=Tc2_System,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc3_Module: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:plc_example_1,DEPENDENCY=Tc3_Module,VERSION=*,VENDOR=Beckhoff Automation GmbH")

cd "$(IOC_TOP)"

## PLC Project Database files ##
dbLoadRecords("plc_example_1.db", "PORT=$(ASYN_PORT),PREFIX=PLC:plc_example_1:,IOCNAME=$(IOC),IOC=$(IOC)")

# Total records: 105
callbackSetQueueSize(2210)

# Autosave and archive settings:
save_restoreSet_status_prefix("PLC:plc_example_1:")
